                ...
                <div className="max-w-md">
                  <Select value={currentTheme} onValueChange={setTheme}>
                    ...
                    >
                            ...
                            <div className="space-y-3">
                              ...
                              <div className="flex space-x-2">
                                ...
                                <div
                                  className="w-6 h-6 rounded-3xl border-2 border-[var(--color-border)]"
                                  style={
                                    { backgroundColor: theme.colors.secondary } as CSSProperties
                                  }
                                />
                                <div
                                  className="w-6 h-6 rounded-3xl border-2 border-[var(--color-border)]"
                      ...
                      {Object.entries(themes)
                        .filter(([key]) =>
                          ['dark', 'softDark', 'midnight', 'volcano', 'twilight', 'storm'].includes(
                            key
                          )
                        )
                        .map(([key, theme]) => (
          ...
          >
            <DialogHeader className="space-y-4">
              ...
              <DialogDescription
                ...
                style={{ color: 'var(--color-text)', opacity: 0.8 } as CSSProperties}
              >
                Are you sure you want to reset the database? This will permanently delete ALL your
                data including:
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="py-6 space-y-6">
              ...
              >
                <ul
                  ...
                  style={{ color: 'var(--color-text)', opacity: 0.9 } as CSSProperties}
                >
              ...
              <div className="bg-red-500 bg-opacity-10 p-6 rounded-xl border-2 border-red-500 border-opacity-30">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-red-600 opacity-90">
