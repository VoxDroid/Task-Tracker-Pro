            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
              <div className="bg-[var(--color-surface)] rounded-xl p-6 border-2 border-[var(--color-border)]">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-xl font-semibold" style={{ color: "var(--color-text)" } as CSSProperties}>
                    Developer
                  </h3>
                </div>
                <p className="text-lg font-medium" style={{ color: "var(--color-text)" } as CSSProperties}>
                  VoxDroid
                </p>
