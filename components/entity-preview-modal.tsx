...
export default function EntityPreviewModal({
            ...
            <div className="flex items-center space-x-3 min-w-0 flex-1">
              ...
              {task.is_favorite === 1 && (
                <Star
                  ...
                  style={
                    { fill: 'var(--color-accent)', color: 'var(--color-accent)' } as CSSProperties
                  }
                />
              )}
            </div>
          ...
          {task.description && (
            ...
            >
              <div
                ...
                style={{ maxHeight: '346px' } as CSSProperties}
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          {task.assigned_to && (
            <div className="flex items-start space-x-3">
              <User
                className="w-5 h-5 opacity-60 flex-shrink-0 mt-0.5"
                style={{ color: 'var(--color-text)' } as CSSProperties}
              />
              <span
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={`${entityType.charAt(0).toUpperCase() + entityType.slice(1).replace('_', ' ')} Preview`}
      size="2xl"
    >
      <div className="space-y-6">
        {loading ? (
          <div className="flex items-center justify-center py-8">
            ...
            <span className="ml-3" style={{ color: 'var(--color-text)' }}>
              Loading...
            </span>
          </div>
        ) : entityData ? (
