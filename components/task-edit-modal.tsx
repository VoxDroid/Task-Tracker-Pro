  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Edit Task" size="2xl">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            ...
            >
              ...
              >
                <SelectItem value="todo" className="rounded-lg cursor-pointer">
                  To Do
                </SelectItem>
                <SelectItem value="in_progress" className="rounded-lg cursor-pointer">
                  In Progress
                </SelectItem>
                <SelectItem value="completed" className="rounded-lg cursor-pointer">
                  Completed
                </SelectItem>
          ...
          <div>
            ...
            >
              ...
              >
                ...
                <SelectItem value="urgent" className="rounded-lg cursor-pointer">
                  Urgent
                </SelectItem>
              </SelectContent>
            </Select>
        ...
        <div
          className="flex justify-end pt-4 border-t-2"
