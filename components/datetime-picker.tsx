    ...
    <div ref={containerRef} className={`relative ${className}`}>
      ...
      >
        <div className="flex items-center space-x-3">
          ...
          <span className={value ? '' : 'opacity-50'}>{formatDisplayValue() || placeholder}</span>
        </div>
        {value && (
          <button
            type="button"
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="relative">
            {/* Calendar View */}
            <div
              className={`transition-all duration-300 ease-out transform ${view === 'calendar' ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-95 -translate-y-2 absolute inset-0 pointer-events-none'}`}
            >
              {view === 'calendar' && (
                <>
                  {/* Calendar Header */}
                  ...
                  <div className="grid grid-cols-7 gap-1 mb-4">
                    {getDaysInMonth(currentMonth).map((day, index) => (
                      ...
                      `}
                        style={
                          {
                            color: isSelected(day!) ? 'white' : 'var(--color-text)'
                          } as CSSProperties
                        }
                      >
                        {day}
            ...
            <div
              className={`transition-all duration-300 ease-out transform ${view === 'month' ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-95 -translate-y-2 absolute inset-0 pointer-events-none'}`}
            >
              {view === 'month' && (
                <>
                  <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-4">
                    {MONTHS.map((month, index) => (
                      ...
                      `}
                        style={
                          {
                            color: currentMonth.getMonth() === index ? 'white' : 'var(--color-text)'
                          } as CSSProperties
                        }
                      >
                        {month.slice(0, 3)}
            ...
            {/* Year Selection View */}
            <div
              className={`transition-all duration-300 ease-out transform ${view === 'year' ? 'opacity-100 scale-100 translate-y-0' : 'opacity-0 scale-95 -translate-y-2 absolute inset-0 pointer-events-none'}`}
            >
              {view === 'year' && (
                <>
                  <div className="flex items-center justify-between mb-4">
                    ...
                    {Array.from({ length: 12 }, (_, i) => yearRangeStart + i).map((year) => (
                      ...
                      `}
                        style={
                          {
                            color:
                              currentMonth.getFullYear() === year ? 'white' : 'var(--color-text)'
                          } as CSSProperties
                        }
                      >
                        {year}
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex rounded-xl border-2 border-[var(--color-border)] overflow-hidden">
                <button
                  ...
                  style={
                    { color: period === 'AM' ? 'white' : 'var(--color-text)' } as CSSProperties
                  }
                >
                  AM
                </button>
                <button
                  ...
                  style={
                    { color: period === 'PM' ? 'white' : 'var(--color-text)' } as CSSProperties
                  }
                >
                  PM
                </button>
